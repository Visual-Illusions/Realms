...
final class SetSanctuaryFlagCommand extends RealmsCommand {
    ...
    final void execute(Mod_Caller caller, String[] args) {
        ...
        try {
            ...
            caller.sendMessage(RealmsTranslate.transformMessage("zoneflag.set", "SANCTUARY", (zone.getSanctuary() ? MCChatForm.GREEN.concat("ON") : MCChatForm.RED.concat("OFF")).concat(zone.getAbsoluteSanctuary().equals(ZoneFlag.INHERIT) ? MCChatForm.PINK.concat("(INHERITED)") : ""), zone.getName()));
