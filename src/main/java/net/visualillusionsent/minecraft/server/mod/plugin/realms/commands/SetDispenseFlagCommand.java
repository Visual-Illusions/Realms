 ...
 */
@RCommand(desc = "Sets a zones Dispensers Flag", name = "dispensers", usage = "<zone|*> <on|off|inherit>", minParam = 2, maxParam = 2)
final class SetDispenseFlagCommand extends RealmsCommand{
    ...
    final void execute(Mod_Caller caller, String[] args){
        ...
        try{
            ...
            caller.sendMessage(RealmsTranslate.transformMessage("zoneflag.set", "DISPENSERS", (zone.getDispensers() ? MCChatForm.GREEN.concat("ON") : MCChatForm.RED.concat("OFF")).concat(zone.getAbsoluteDispensers().equals(ZoneFlag.INHERIT) ? MCChatForm.PINK.concat("(INHERITED)") : ""), zone.getName()));
        }
