...
public class RealmsHooks{
     ...
     */
    public class PermissionCheck implements PluginInterface{
     ...
     */
    public class ZoneCheck implements PluginInterface{
        public String getName(){
     ...
     */
    public class ZoneFlagCheck implements PluginInterface{
        public String getName(){
         ...
         * 
         * @param Flag
         * @param Player or Block or ZoneName
        ...
        public Object run(Object[] args) {
            ...
            if(Flag != null){
                try{
                    ...
                    if(zone != null){
                        if(Flag.equalsIgnoreCase("PVP"))                return zone.getPVP();
                        else if(Flag.equalsIgnoreCase("Sanctuary"))     return zone.getSanctuary();
                        else if(Flag.equalsIgnoreCase("Creeper"))       return zone.getCreeper();
                        else if(Flag.equalsIgnoreCase("Ghast"))         return zone.getGhast();
                        else if(Flag.equalsIgnoreCase("Fall"))          return zone.getFall();
                        else if(Flag.equalsIgnoreCase("Suffocate"))     return zone.getSuffocate();
                        else if(Flag.equalsIgnoreCase("Fire"))          return zone.getFire();
                        else if(Flag.equalsIgnoreCase("Animals"))       return zone.getAnimals();
                        else if(Flag.equalsIgnoreCase("Physics"))       return zone.getPhysics();
                        else if(Flag.equalsIgnoreCase("Creative"))      return zone.getCreative();
                        else if(Flag.equalsIgnoreCase("Pistons"))       return zone.getPistons();
                        else if(Flag.equalsIgnoreCase("Healing"))       return zone.getHealing();
                        else if(Flag.equalsIgnoreCase("Enderman"))      return zone.getEnderman();
                        else if(Flag.equalsIgnoreCase("Spread"))        return zone.getSpread();
                        else if(Flag.equalsIgnoreCase("Flow"))          return zone.getFlow();
                        else if(Flag.equalsIgnoreCase("TNT"))           return zone.getTNT();
                        else if(Flag.equalsIgnoreCase("Potion"))        return zone.getPotion();
                        else if(Flag.equalsIgnoreCase("Starve"))        return zone.getStarve();
                        else if(Flag.equalsIgnoreCase("Restricted"))    return zone.getRestricted();
                    }
                }catch(ZoneNotFoundException ZNFE){
                    rhandle.log(Level.WARNING, "Another plugin gave a Zone name that was INVAILD!");
                }
     ...
     */
    public class PermissionChange implements PluginInterface{
        public String getName(){
     ...
     * Zone Flags Change
     */
    public class ZoneChange implements PluginInterface{
        public String getName(){
        ...
        public Object run(Object[] args) {
            ...
            try{
                ...
                if(Type.equalsIgnoreCase("PVP")) zone.setPVP(theType);
                else if(Type.equalsIgnoreCase("Sanctuary"))     zone.setSanctuary(theType);
                else if(Type.equalsIgnoreCase("Creeper"))       zone.setCreeper(theType);
                else if(Type.equalsIgnoreCase("Ghast"))         zone.setGhast(theType);
                else if(Type.equalsIgnoreCase("Fall"))          zone.setFall(theType);
                else if(Type.equalsIgnoreCase("Suffocate"))     zone.setSuffocate(theType);
                else if(Type.equalsIgnoreCase("Fire"))          zone.setFire(theType);
                else if(Type.equalsIgnoreCase("Animals"))       zone.setAnimals(theType);
                else if(Type.equalsIgnoreCase("Physics"))       zone.setPhysics(theType);
                else if(Type.equalsIgnoreCase("Creative"))      zone.setCreative(theType);
                else if(Type.equalsIgnoreCase("Pistons"))       zone.setPistons(theType);
                else if(Type.equalsIgnoreCase("Healing"))       zone.setHealing(theType);
                else if(Type.equalsIgnoreCase("Enderman"))      zone.setEnderman(theType);
                else if(Type.equalsIgnoreCase("Spread"))        zone.setSpread(theType);
                else if(Type.equalsIgnoreCase("Flow"))          zone.setFlow(theType);
                else if(Type.equalsIgnoreCase("TNT"))           zone.setTNT(theType);
                else if(Type.equalsIgnoreCase("Potion"))        zone.setPotion(theType);
                else if(Type.equalsIgnoreCase("Starve"))        zone.setStarve(theType);
                else if(Type.equalsIgnoreCase("Restricted"))    zone.setRestricted(theType);
                else{
