 ...
 */
@RCommand(desc = "Sets a zones Restricted Flag", name = "restricted", usage = "<zone|*> <on|off|inherit>", minParam = 2, maxParam = 2)
final class SetRestrictedFlagCommand extends RealmsCommand{
    ...
    final void execute(Mod_Caller caller, String[] args){
        ...
        try{
            ...
            caller.sendMessage(RealmsTranslate.transformMessage("zoneflag.set", "RESTRICTED", (zone.getRestricted() ? MCChatForm.GREEN.concat("ON") : MCChatForm.RED.concat("OFF")).concat(zone.getAbsoluteRestricted().equals(ZoneFlag.INHERIT) ? MCChatForm.PINK.concat("(INHERITED)") : ""), zone.getName()));
        }
